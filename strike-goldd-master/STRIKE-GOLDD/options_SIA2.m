...
function [modelname,paths,opts,prev_ident_pars] = options_SIA2()

%=================== BASIC OPTIONS ("CHOOSE WHAT TO DO") ==================
%%% (1) CHOOSE MODEL TO ANALYSE: 
modelname ='ladder_hxsumSMsum_pall';    % Name of a .mat file placed in the 'models' folder 
...
opts.algorithm = 2;  % Choose one of the following:
   %--- Structural Identifiability and Observability (SIO) algorithms:
    ...
    %--- Symmetries and Reparameterization algorithms:
      ...
      % 7: SIM_PDE         -- search for scaling symmetries in PDE models
...
opts.nnzDerU    = [1 1];     % In FISPO, numbers of nonzero derivatives of the measured inputs (u); may be 'inf'

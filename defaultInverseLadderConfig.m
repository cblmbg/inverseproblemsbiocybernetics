...
cfg.level4.trueWeights = [ ...
    ...
    0.05, 0.05; ...
    0.15, 0.08];
cfg.level4.featureNames = ["Own biomass"; "Regularized allocation effort"; ...
    "Received-metabolite deficit"; "Partner biomass"];
cfg.level4.maximumBestResponseIterations = 20;
cfg.level4.bestResponseTolerance = 3e-3;
cfg.level4.unilateralImprovementTolerance = 1e-4;
